...
import { WagesApprovalListComponent } from './components/wages-approval-list/wages-approval-list.component';

const routes: Routes = [
  {
    path: '',
    component: WagesApprovalListComponent, pathMatch: 'full'
  },
]

@NgModule({
  declarations: [
    WagesApprovalListComponent
  ],
  imports: [
    CommonModule
...
export class WagesApprovalModule { }
